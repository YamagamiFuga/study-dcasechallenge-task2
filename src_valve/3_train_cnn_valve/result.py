...
supplemental_dir = os.path.join(base_dir, "valve/supplemental")
...
class TrainDataset(Dataset):
    def __init__(self, noisy_paths,processor):
...
model = ResNetFrontend(n_classes=8, emb_dim=256)

# model.load_state_dict(torch.load("cnn_frontend_valve_pseudo_clusters_8.pth", map_location="cpu"))
